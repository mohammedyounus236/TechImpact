...
var recY = 300; //creates and sets recY to 300
var recStroke = 35; //creates and sets recStroke to 35
var recCol = 0; //creates and sets recCol to 0
...
function draw() { //draw function
  ...
  if(circX > width || circX < 0){ //checks the condition to see if the circX is greater than the width or less than 0
